...
(self.webpackJsonp__wix_thunderbolt_app =
  ...
  [316, 3605],
  {
    81220: function (e, c, i) {
      ...
      const u = (e) => -(Math.cos(Math.PI * e) - 1) / 2,
        t = (e) => (e < 0.5 ? 2 * e ** 2 : 1 - (-2 * e + 2) ** 2 / 2),
        b = (e) =>
          e < 0.5
    ...
    49563: function (e, c, i) {
      ...
      const u = ["iframe", "input", "select", "textarea", "button"],
        t = (e) => {
          const c = e.tagName.toLowerCase(),
            i = e.getAttribute("href"),
            t = e.getAttribute("tabIndex");
          return u.includes(c) || ("a" === c && !!i) || (!!t && "-1" !== t);
        };
    },
  },
]);
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/windowScroll.bc5f1bd7.chunk.min.js.map

  ...
  [974],
  {
    ...
    41217: function (t, e, n) {
      ...
      function s(t, e, n) {
        void 0 === t && (t = [0, 0]),
          ...
          void 0 === n && (n = 0);
        return (
          (360 + n + (180 * Math.atan2(e[1] - t[1], e[0] - t[0])) / Math.PI) %
          360
        );
      }
    },
    8242: function (t, e, n) {
      ...
      function r(t, e, n) {
        ...
        return (
          "entry" === i
            ? ((u = r - e), (h = Math.min(e, c)))
            : "contain" === i
            ? ((u = Math.min(s - e, r)), (h = Math.abs(e - c)))
            : "exit" === i
            ? ((u = Math.max(r, s - e)), (h = Math.min(e, c)))
            : "cover" === i && ((u = r - e), (h = c + e)),
          (u + f * h) | 0
        );
      }
          ...
          t.forEach((e, c) => {
            ...
            if (f) {
              if ("end" in f) {
                ...
                if (u) {
                  const t =
                      ((o ? e.element.offsetWidth : e.element.offsetHeight) ||
                        0) +
                      f.end -
                      i,
                    c = r + t - e.offset,
      ...
      function h(t, e, n, i, h) {
        const d = t.viewSource,
          a = window.getComputedStyle(d),
          l = c(a),
          v = l ? u(a, i) : void 0;
        let g = d.offsetParent,
          p = 0,
          w = "fixed" === a.position;
        const m = f(d, i, l);
        (v && "end" in v) || (p += m);
        const b = (i ? d.offsetWidth : d.offsetHeight) || 0,
          E = [
            { element: d, offset: m, size: b, sticky: v, style: l ? a : null },
          ];
        for (; g; ) {
          if (g === e) {
            E.push({ element: g, offset: 0 });
            break;
          }
          const t = window.getComputedStyle(g),
            ...
            r = f(g, i, n);
          (o && "end" in o) || (p += r),
            E.push({ element: g, offset: r, sticky: o }),
            (g = g.offsetParent),
            g || (w = "fixed" === t.position);
        }
        E.reverse();
        const x = (function (t, e, n, i, c, f) {
          const { start: u, end: h, duration: d } = t;
          let a,
            l = u,
            v = h,
            g = t.startRange,
          ...
          if ("string" == typeof d) {
            ...
            if (g || u?.name) {
              ...
              l = h.start + (g.offset / 100) * (h.end - h.start) + t;
            }
            if (p || h?.name) {
              p = p || h;
              const t = o(p.add, c),
              ...
              v = u.start + (p.offset / 100) * (u.end - u.start) + t;
        ...
        })(t, { start: p, end: p + b }, n, i, h, E);
        return (x.isFixed = w), x;
      }
      n.d(e, {
        O: function () {
          return p;
          ...
          ((e.scenes = t.scenes.map(
            (t, i) => (
              ...
              t.viewSource && ("string" == typeof t.duration || t.start?.name)
                ? ((t = h(t, n, g, o, w)), e.observeSourcesResize && p.push(t))
          ...
          if (window.ResizeObserver) {
            ...
            (f = new window.ResizeObserver(function (i) {
              i.forEach((i) => {
                ...
                (e.scenes[r.index] = h(r, n, g, o, w)),
                  p.splice(p.indexOf(r), 1, e.scenes[r.index]);
              });
            })),
              p.forEach((e) => {
          ...
          e.observeViewportResize &&
            ...
            n === window
              ...
              : window.ResizeObserver &&
                ((v = new window.ResizeObserver(u)),
                v.observe(n, { box: "border-box" })));
        }
        return (
          e.observeViewportEntry &&
            ...
            e.scenes.forEach((t) => {
              if (t.viewSource) {
                ...
                e ||
                  ((e = []), r.set(t.viewSource, e), c.observe(t.viewSource)),
                  e.push(t);
              }
            })),
          {
            tick: function ({ p: t, vp: n }) {
              t = +t.toFixed(1);
              const i = +n.toFixed(4);
              if (t !== s) {
                for (let n of e.scenes)
                  if (!n.disabled) {
                    const { start: e, end: o, duration: r } = n,
                      s = a(t, e, o, r);
      ...
      class p {
        ...
        resetProgress(t = {}) {
          ...
          (this.progress.p = o),
            ...
            t && this.config.root.scrollTo(n, i);
        }
        tick(t) {
        ...
        setupEffect() {
          this.removeEffect(), (this.effect = v(this.config));
        }
        removeEffect() {
          ...
          t.scenes.forEach((e) => {
            e.target &&
              ...
              t.root
                ...
                : ((o = f.bind(null, t)), window.addEventListener("resize", o));
          }),
          (e = function (e) {
            for (let n of t.scenes)
              if (!n.disabled) {
                const o = +i(
                    0,
                    1,
                    n.transform?.x(e.x) || e.x / t.rect.width
                  ).toPrecision(4),
                  r = +i(
                    0,
                    1,
                    n.transform?.y(e.y) || e.y / t.rect.height
                  ).toPrecision(4),
                  s = { x: e.vx, y: e.vy };
                n.effect(n, { x: o, y: r }, s);
              }
            Object.assign(d, e);
          }),
...
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/animations.6f0c6ebb.chunk.min.js.map
